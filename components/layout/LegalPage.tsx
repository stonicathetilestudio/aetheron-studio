        ...
        <main className="min-h-screen bg-black text-white selection:bg-primary/30 relative">
            ...
            <div className="container px-4 md:px-6 py-32 max-w-4xl mx-auto relative z-10">
                ...
                >
                    ...
                    <div className="flex items-center gap-2 text-zinc-500 text-sm mb-12 border-b border-white/10 pb-8">
                        <Clock className="w-4 h-4" />
                        <span>Last updated: {date}</span>
                    </div>

                    <div className="prose prose-invert prose-lg max-w-none prose-headings:text-white prose-p:text-zinc-400 prose-a:text-primary hover:prose-a:text-purple-400 prose-strong:text-white prose-li:text-zinc-400">
                        {children}
                    </div>
                </motion.div>
            </div>
